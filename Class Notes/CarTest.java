...
public class CarTest
{
    ...
    public void testGetFuelInTank()
    {
         ...
         *      is equal to the actual (returned) value. If not, the test
         *      fails.
         *  Specify the expected value first and the actual value second.
         *  For doubles (only for doubles), specify a third value which is
         *      the epsilon (i.e., how close is close enough to be equal.
         */
    ...
    {
        Car testCar = new Car();
        String vin =  new String("V1234098023948A");
        testCar.setVIN(vin);
